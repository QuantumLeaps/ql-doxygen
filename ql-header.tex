% original: https://github.com/doxygen/doxygen/blob/master/templates/latex/header.tex
...
%%END LATEX_FONTENC
  ...
  \fancypagestyle{fancyplain}{
    \fancyhf{}
    \fancyhead[LE, RO]{\bfseries $projectname \scriptsize $projectnumber}
    \fancyhead[LO]{\bfseries\rightmark}
    \fancyhead[RE]{\bfseries\leftmark}
    \fancyfoot[LO, RE]{\bfseries\thepage}
    \fancyfoot[C]{\bfseries\scriptsize\copyright\copyrightname}
  }
...
%%END PDF_HYPERLINKS
  ...
  \color{frontfg}
  \vspace*{7cm}
  \null{\fontsize{50}{58} \selectfont $projectname \fontsize{40}{48} \selectfont $projectnumber }\\
  \line(1,0){800}\\
  {\large $projectbrief}\\
